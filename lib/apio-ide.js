...
export default {
  ...
  setupCommands: function() {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      //-- Led example
      'apio:example-leds': (event) => {
        console.log("Event: leds");
        this.examples('leds')
      },

      //-- Wire example
      'apio:example-wire': (event) => {
        this.examples('wire')
      },

      //-- IceZUM examples

      'apio:example-icezum-leds': (event) => {
        this.examples('icezum/leds')
      },

      'apio:example-icezum-template': (event) => {
        this.examples('icezum/template')
      },

      'apio:example-icezum-pcf': (event) => {
        this.examples('icezum/pcf')
      },

      //-- iCEstick

      'apio:example-icestick-leds': (event) => {
        this.examples('icestick/leds')
      },

      'apio:example-icestick-template': (event) => {
        this.examples('icestick/template')
      },

      'apio:example-icestick-pcf': (event) => {
        this.examples('icestick/pcf')
      },

      //-- Go board

      'apio:example-go-board-leds': (event) => {
        this.examples('go-board/leds')
      },

      'apio:example-go-board-template': (event) => {
        this.examples('go-board/template')
      },

      'apio:example-go-board-pcf': (event) => {
        this.examples('go-board/pcf')
      },

      //-- icoBOARD 1.0

      'apio:example-icoboard-leds': (event) => {
        this.examples('icoboard/leds')
      },

      'apio:example-icoboard-template': (event) => {
        this.examples('icoboard/template')
      },

      'apio:example-icoboard-pcf': (event) => {
        this.examples('icoboard/pcf')
      },

      //-- iCE40-HX8K

      'apio:example-iCE40-HX8K-leds': (event) => {
        this.examples('iCE40-HX8K/leds')
      },

      //-- Cat board

      'apio:example-Cat-board-blinky': (event) => {
        this.examples('Cat-board/blinky')
      },
