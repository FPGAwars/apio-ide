...
export default {
  ...
  initProject() {
    ...
    view.handleInit = () => {
      ...
      //-- Call the apio examples -f leds --project-dir projectPath command
      //-- Prepare the arguments
      const args2 = ['examples', '-f','leds', '-n', '--project-dir']
  ...
  examples() {
    ...
    if (projectpaths.length >= 1) {
      ...
      const args = ['examples', '-f', 'leds', '-n', '--project-dir'];
      args.push(projectpath);
      spawnAPio(args);
    }
    else {
      ...
      const args = ['examples', '-d', 'leds', '-n', '--project-dir'];
      args.push(projectpath);
      examplepath = path.join(projectpath,'leds')
